...
ZEXTERN ZEXPORT int deflateGetDictionary OF((z_streamp strm,
                                             Bytef *dictionary,
                                             uInt  *dictLength));
/*
...
ZEXTERN ZEXPORT int deflateTune OF((z_streamp strm,
                                    int good_length,
                                    int max_lazy,
                                    int nice_length,
                                    int max_chain));
...
ZEXTERN ZEXPORT int deflatePending OF((z_streamp strm,
                                       unsigned *pending,
                                       int *bits));
/*
...
ZEXTERN ZEXPORT int deflateSetHeader OF((z_streamp strm,
                                         gz_headerp head));
/*
...
ZEXTERN ZEXPORT int inflateGetDictionary OF((z_streamp strm,
                                             Bytef *dictionary,
                                             uInt  *dictLength));
/*
...
ZEXTERN ZEXPORT int inflateReset2 OF((z_streamp strm,
                                      int windowBits));
/*
...
ZEXTERN ZEXPORT int inflatePrime OF((z_streamp strm,
                                     int bits,
                                     int value));
/*
...
ZEXTERN ZEXPORT long inflateMark OF((z_streamp strm));
/*
...
ZEXTERN ZEXPORT int inflateGetHeader OF((z_streamp strm,
                                         gz_headerp head));
/*
...
ZEXTERN ZEXPORT int uncompress2 OF((Bytef *dest,   uLongf *destLen,
                                    const Bytef *source, uLong *sourceLen));
/*
...
ZEXTERN ZEXPORT int gzbuffer OF((gzFile file, unsigned size));
/*
...
ZEXTERN ZEXPORT z_size_t gzfread OF((voidp buf, z_size_t size, z_size_t nitems,
                                     gzFile file));
/*
...
ZEXTERN ZEXPORT z_size_t gzfwrite OF((voidpc buf, z_size_t size,
...
ZEXTERN ZEXPORT int gzprintf Z_ARG((gzFile file, const char *format, ...));
/*
...
ZEXTERN ZEXPORT int gzclose_r OF((gzFile file));
ZEXTERN ZEXPORT int gzclose_w OF((gzFile file));
/*
...
ZEXTERN ZEXPORT uLong adler32_z OF((uLong adler, const Bytef *buf,
                                    z_size_t len));
/*
...
ZEXTERN ZEXPORT uLong ZEXPORT crc32_z OF((uLong adler, const Bytef *buf,
                                  z_size_t len));
/*
...
ZEXTERN ZEXPORT int gzgetc_ OF((gzFile file));  /* backward compatibility */
#ifdef Z_PREFIX_SET
#  undef z_gzgetc
#  define z_gzgetc(g) \
...
#  endif
   ...
   ZEXTERN ZEXPORT z_off_t gzoffset OF((gzFile));
...
ZEXTERN ZEXPORT int            inflateValidate OF((z_streamp, int));
ZEXTERN ZEXPORT unsigned long  inflateCodesUsed OF ((z_streamp));
ZEXTERN ZEXPORT int            inflateResetKeep OF((z_streamp));
ZEXTERN ZEXPORT int            deflateResetKeep OF((z_streamp));
...
#  ifndef Z_SOLO
ZEXTERN ZEXPORTVA int          gzvprintf Z_ARG((gzFile file, const char *format, va_list va));
#  endif
#endif
